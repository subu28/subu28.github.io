var newsText = new Array();
    ...
    newsText[1] = "<font color=\"#FFF8C6\" text-decoration : none; font-size: 12px;>Registrations For Autonex workshop has started";
    ...
    newsText[3] = "<font color=\"#FFF8C6\" font-size: 12px;>Register for Online Photography Event fringes";
    ...
    newsText[11] = "<font color=\"#FFF8C6\" font-size: 12px;>Celestial Inquisition has started,click here to download problem statement";
    newsText[12] = "<font color=\"#FFF8C6\" font-size: 12px;>Having trouble in registration or logging in ?";
    newsText[13] = "<font color=\"#FFF8C6\" font-size: 12px;>Last date for submission of biolock abstract has been shifted to 15th jan 2011";
...
var linkURL = new Array();
    ...
    linkURL[3]="./server/eventRegistration.jsp";
    ...
    linkURL[11]="./problem_celestial.pdf";
